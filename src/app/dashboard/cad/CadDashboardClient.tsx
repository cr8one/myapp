...
type Stats = {
  cadRequestCount: number
  dxfRequestCount: number
  daishiDbCount: number
  workLogCount: number
}
...
const cards: Card[] = [
  {
    ...
    icon: FileText,
    bg: "bg-lime-50", text: "text-lime-600", border: "border-lime-100", hover: "hover:border-lime-300",
    key: "cadRequestCount",
  },
  {
    label: "DXF変換依頼書",
    ...
    icon: RefreshCw,
    bg: "bg-green-50", text: "text-green-600", border: "border-green-100", hover: "hover:border-green-300",
    key: "dxfRequestCount",
  },
  {
    label: "台紙作成依頼書",
    ...
    icon: Layout,
    bg: "bg-teal-50", text: "text-teal-600", border: "border-teal-100", hover: "hover:border-teal-300",
    badge: "準備中",
  },
  {
    label: "DXF・台紙DB",
...
export default function CadDashboardClient({ stats }: { stats: Stats }) {
