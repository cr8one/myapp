...
type Contact = { department: string; position: string; name: string; honorific: string }
const emptyContact = (): Contact => ({ department: "", position: "", name: "", honorific: "" })
export default function AddressBookNewPage() {
  ...
  const handleSubmit = async () => {
    setSaving(true)
    const validContacts = contacts.filter(c => c.name || c.department || c.position)
