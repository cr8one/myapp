...
const COLUMNS = [
  ...
  { no: 3,  name: "得意先名2（支店名）",                      field: "tokuinm2",              type: "Varchar",  size: "64",  null: "",         pk: "",  備考: "" },
  { no: 4,  name: "得意先名3",                                field: "tokuinm3",              type: "Varchar",  size: "64",  null: "",         pk: "",  備考: "" },
  { no: 5,  name: "得意先略名",                               field: "ryk_nm",                type: "Varchar",  size: "40",  null: "",         pk: "",  備考: "" },
  { no: 6,  name: "得意先名カナ",                             field: "tokuikana",             type: "Varchar",  size: "60",  null: "",         pk: "",  備考: "" },
  { no: 7,  name: "論理削除フラグ",                           field: "del_flg",               type: "int",      size: "",    null: "NOT NULL", pk: "",  備考: "" },
  { no: 8,  name: "データ作成日",                             field: "dtindt",                type: "Varchar",  size: "8",   null: "NOT NULL", pk: "",  備考: "yyyymmdd" },
  { no: 9,  name: "データ作成時間",                           field: "dtintm",                type: "Varchar",  size: "8",   null: "NOT NULL", pk: "",  備考: "hh:mm:ss" },
  { no: 10, name: "データ更新日",                             field: "dtupdt",                type: "Varchar",  size: "8",   null: "NOT NULL", pk: "",  備考: "yyyymmdd" },
  { no: 11, name: "データ更新時間",                           field: "dtuptm",                type: "Varchar",  size: "8",   null: "NOT NULL", pk: "",  備考: "hh:mm:ss" },
  ...
  { no: 16, name: "相手先住所３",                             field: "aitesaki_address3",     type: "Varchar",  size: "50",  null: "",         pk: "",  備考: "" },
  ...
  { no: 20, name: "地域コード",                               field: "tiiki_cd",              type: "Numeric",  size: "2,0", null: "",         pk: "",  備考: "" },
  ...
  { no: 35, name: "請求元コード",                             field: "seikyum_cd",            type: "Numeric",  size: "2,0", null: "",         pk: "",  備考: "" },
  { no: 36, name: "振込先コード",                             field: "furikomis_cd",          type: "Numeric",  size: "2,0", null: "",         pk: "",  備考: "" },
  { no: 37, name: "E-mail",                                   field: "tmail",                 type: "Varchar",  size: "30",  null: "",         pk: "",  備考: "" },
  { no: 38, name: "カガミ出力フラグ",                         field: "kagami_flg",            type: "Numeric",  size: "1,0", null: "",         pk: "",  備考: "0:出力しない　1:出力する" },
  { no: 39, name: "回収予定月",                               field: "ky_mon",                type: "Numeric",  size: "2,0", null: "",         pk: "",  備考: "" },
  { no: 40, name: "回収予定日",                               field: "ky_dt",                 type: "Numeric",  size: "2,0", null: "",         pk: "",  備考: "" },
  { no: 41, name: "前月残請求フラグ",                         field: "zzan_sei_flg",          type: "Numeric",  size: "1,0", null: "",         pk: "",  備考: "0:請求しない　1:請求する" },
  { no: 42, name: "入金方法",                                 field: "ny_houhou",             type: "Numeric",  size: "18,0",null: "",         pk: "",  備考: "0:一括入金入力　1:受注消込入金入力" },
  { no: 43, name: "入金科目コード",                           field: "ny_kamoku_cd",          type: "Numeric",  size: "1,0", null: "",         pk: "",  備考: "" },
  { no: 44, name: "入金口座コード",                           field: "nykoza_cd",             type: "Numeric",  size: "5,0", null: "",         pk: "",  備考: "" },
  { no: 45, name: "得意先コード（FX4）",                      field: "fx4_tokui_cd",          type: "Numeric",  size: "6,0", null: "",         pk: "",  備考: "" },
  { no: 46, name: "消費税端数処理",                           field: "hasu_kbn",              type: "smallint", size: "",    null: "NOT NULL", pk: "",  備考: "DEFAULT 1 / 1:四捨五入 2:切捨て 3:切り上げ" },
  { no: 47, name: "消費税単位",                               field: "shohizei_kbn",          type: "smallint", size: "",    null: "NOT NULL", pk: "",  備考: "DEFAULT 2 / 1:一括　2:伝票単位　3:明細単位" },
  { no: 48, name: "得意先コード",                             field: "tokuisaki_cd",          type: "Varchar",  size: "5",   null: "NOT NULL", pk: "○", 備考: "" },
  { no: 49, name: "支店コード",                               field: "siten_cd",              type: "Varchar",  size: "3",   null: "NOT NULL", pk: "○", 備考: "" },
  { no: 50, name: "出荷予備フラグ",                           field: "syk_yobi_flg",          type: "int",      size: "",    null: "",         pk: "",  備考: "参照 m_syk_yobi" },
  { no: 51, name: "見積書種類",                               field: "mitsumorisho_id",       type: "int",      size: "",    null: "",         pk: "",  備考: "" },
  { no: 52, name: "見積書計算方法",                           field: "mitsumori_calc_id",     type: "int",      size: "",    null: "",         pk: "",  備考: "" },
  { no: 53, name: "集金種別１",                               field: "syukin_syubetu1",       type: "int",      size: "",    null: "",         pk: "",  備考: "現金・振込・手形など" },
  { no: 54, name: "集金口座１",                               field: "syukin_koza1",          type: "int",      size: "",    null: "",         pk: "",  備考: "" },
  { no: 55, name: "集金種別２",                               field: "syukin_syubetu2",       type: "int",      size: "",    null: "",         pk: "",  備考: "現金・振込・手形など" },
  { no: 56, name: "集金口座２",                               field: "syukin_koza2",          type: "int",      size: "",    null: "",         pk: "",  備考: "" },
  { no: 57, name: "集金単位",                                 field: "syukin_tani",           type: "int",      size: "",    null: "",         pk: "",  備考: "0:円　1:％" },
  { no: 58, name: "金額・％",                                 field: "syukin_kingaku",        type: "int",      size: "",    null: "",         pk: "",  備考: "集金種別１にあたる金額または％の数値" },
  { no: 59, name: "金額端数処理",                             field: "kin_hasu_kbn",          type: "smallint", size: "",    null: "",         pk: "",  備考: "1:四捨五入 2:切捨て 3:切り上げ" },
  { no: 60, name: "税丸め単位",                               field: "zei_marume_tani",       type: "smallint", size: "",    null: "",         pk: "",  備考: "1:1円単位 2:10円単位 3:100円単位" },
  { no: 61, name: "元帳表示フラグ",                           field: "mototyo_vis_flg",       type: "smallint", size: "",    null: "",         pk: "",  備考: "0:表示しない 1:表示する" },
  { no: 62, name: "ソニーフラグ",                             field: "sony_flg",              type: "smallint", size: "",    null: "",         pk: "",  備考: "0:ソニーでない 1:ソニー" },
  { no: 63, name: "納本検査規格ID",                           field: "nohon_kensa_kikaku_id", type: "Varchar",  size: "10",  null: "NOT NULL", pk: "",  備考: "DEFAULT '0'" },
  { no: 64, name: "請求区分",                                 field: "seikyu_kbn",            type: "smallint", size: "",    null: "NOT NULL", pk: "",  備考: "DEFAULT 1" },
  { no: 65, name: "接待交際費対象外フラグ",                   field: "non_entertainment_flg", type: "smallint", size: "",    null: "",         pk: "",  備考: "DEFAULT 0" },
  { no: 66, name: "SMCオンラインフラグ",                      field: "smc_online_flg",        type: "smallint", size: "",    null: "",         pk: "",  備考: "DEFAULT 0" },
]
