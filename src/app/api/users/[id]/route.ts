      ...
      permission: permission ? {
        upsert: {
          create: {
            ...
            addressBookView: permission.addressBookView ?? true,
            addressBookEdit: permission.addressBookEdit ?? false,
            addressBookChangeRequestTarget: permission.addressBookChangeRequestTarget ?? false,
            ssssIssuerOrder:            0,
            ssssSupplierOrder:          0,
            ssssReceiverOrder:          0,
          ...
          update: {
            ...
            manufacturingView: permission.manufacturingView,
            manufacturingEdit: permission.manufacturingEdit,
            trayView:          permission.trayView,
            trayEdit:          permission.trayEdit,
            dppStorageLedgerImport: permission.dppStorageLedgerImport,
            ...
            addressBookView: permission.addressBookView,
            addressBookEdit: permission.addressBookEdit,
            addressBookChangeRequestTarget: permission.addressBookChangeRequestTarget,
